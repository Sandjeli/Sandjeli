...
function Valider(){
    ...
    if(oc<10){
        ...
        document.getElementById('forme').innerHTML ='<button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="Quiz3.html">Refaire le Quiz</a></button><button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="chapitre3.html">Revoir le Cours</a></button>'
    }else if(oc>=10 && oc<=15){
        ...
        document.getElementById('forme').innerHTML ='<button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="chapitre3.html">Revoir le Cours</a></button><button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="Quiz3.html">Refaire le Quiz</a></button><button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="chapitre4.html">Chapitre Suivant</a></button><br><br>Vous pouvez le faire autant de fois que vous le voulez';
    }else{
    ...
    //document.getElementById('forme').innerHTML ='<button id="buttonrefreshquiz"><a id="buttonrefreshquiz" href="Quiz3.html">Refaire le Quiz</a></button><button id="buttonrefreshquiz"><a id="buttonrefreshquiz" href="chapitre4.html">Chapitre Suivant</a></button><br><br>Vous pouvez le faire autant de fois que vous le voulez';
}
