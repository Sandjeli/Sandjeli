...
function Valider(){
    ...
    if(oc<10){
        ...
        document.getElementById('forme').innerHTML ='<button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="Quiz6.html">Refaire le Quiz</a></button><button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="chapitre6.html">Revoir le Cours</a></button>'
    }else if(oc>=10 && oc<=15){
        ...
        document.getElementById('forme').innerHTML ='<button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="chapitre6.html">Revoir le Cours</a></button><button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="Quiz6.html">Refaire le Quiz</a></button><button class="buttonrefreshquiz"><a class="buttonrefreshquiz" href="chapitre7.html">Chapitre Suivant</a></button><br><br>Vous pouvez le faire autant de fois que vous le voulez';
    }else{
